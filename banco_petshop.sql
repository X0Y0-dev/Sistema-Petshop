...
/*INSERINDO PRIMARY KEY DA IMAGEM NA TABELA*/
ALTER TABLE pet ADD COLUMN id_imagem INT;
ALTER TABLE pet ADD CONSTRAINT fk_pet_imagem FOREIGN KEY (id_imagem) REFERENCES imagens(id_imagem);
...
/*INSERINDO INFORMAÇÕES ESSÊNCIAIS NA TABELA PETSHOP:*/
INSERT INTO petshop (id_petshop, nome_petshop, telefone_petshop, cep)
VALUES(1, 'Pet Xaublin', '+99 (99) 9999-999', '00000000');
...
/*INSERINDO INFORMAÇÕES ESSÊNCIAIS NA TABELA DE ENDEREÇO PETSHOP:*/
INSERT INTO endereco_petshop (id_endereco, logradouro, numero, complemento, bairro, cidade, estado, id_petshop)
VALUES(1, 'Rua Mãe Joana', '42', 'Sem complemento', 'Carajio', 'Tupi', 'SP', 1);
